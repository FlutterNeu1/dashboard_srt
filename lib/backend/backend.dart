...
import 'schema/promotionphoto_record.dart';
import 'schema/tax_record.dart';
import 'schema/if_bookingdone_record.dart';
...
export 'schema/promotionphoto_record.dart';
export 'schema/tax_record.dart';
export 'schema/if_bookingdone_record.dart';
...
/// Functions to query PromotionphotoRecords (as a Stream and as a Future).
Future<int> queryPromotionphotoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PromotionphotoRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PromotionphotoRecord>> queryPromotionphotoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PromotionphotoRecord.collection,
      PromotionphotoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PromotionphotoRecord>> queryPromotionphotoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query IfBookingdoneRecords (as a Stream and as a Future).
Future<int> queryIfBookingdoneRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      IfBookingdoneRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<IfBookingdoneRecord>> queryIfBookingdoneRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      IfBookingdoneRecord.collection,
      IfBookingdoneRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<IfBookingdoneRecord>> queryIfBookingdoneRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
